...
class SentenceSplitterPlugin(TextProcessorPlugin):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.conjunctions = {
            ...
            # 从属连接词
            "because", "since", "as", "if", "when", "while", "although", "though", 
            "unless", "until", "before", "after",
            # 其他连接词
            "however", "therefore", "moreover", "furthermore", "nevertheless", 
            "meanwhile", "consequently", "additionally", "similarly", "likewise", 
            "otherwise", "instead", "rather", "indeed",
            # 从句引导词
            "which", "that", "who", "whom", "whose", "where", "when", "why", "how",
            # 时间/条件连接词
            "then", "next", "finally", "meanwhile", "subsequently",
            # 短语连接词
            "such as", "as well as", "in order to", "so that", "in case", 
            "provided that", "even though", "as though", "as if",
        }
        ...
        self.conjunction_priority = {
            ...
            "where": 1, "when": 1, "why": 1, "how": 1,
            # 其他连接词（中等优先级）
            "additionally": 1, "similarly": 1, "likewise": 1,
            "otherwise": 1, "instead": 1, "rather": 1, "indeed": 1,
            # 低优先级连接词
            "and": 0, "or": 0, "so": 0, "for": 0, "nor": 0,
            "then": 0, "next": 0, "finally": 0, "subsequently": 0, "even": 0,
            # 短语连接词（低优先级）
            "such as": 0, "as well as": 0, "in order to": 0,
            "so that": 0, "in case": 0, "provided that": 0,
            "even though": 0, "as though": 0, "as if": 0,
        }
