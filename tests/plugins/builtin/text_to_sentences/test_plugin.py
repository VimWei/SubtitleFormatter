...
class TestTextToSentencesPlugin:
    ...
    def test_plugin_initialization(self):
        ...
        assert self.plugin.abbreviation_patterns == [
            "Mr.",
            "Mrs.",
            "Dr.",
            "Prof.",
    ...
    def test_custom_abbreviation_patterns(self):
        """测试自定义缩写词模式"""
        plugin = TextToSentencesPlugin({"abbreviation_patterns": ["Dr.", "Prof."]})
    ...
    def test_abbreviation_in_middle_of_sentence(self):
        ...
        test_cases = [
            (
                "Hello Mr. Smith went to the store.",
                ["Hello Mr.Smith went to the store."],
            ),  # 插件会移除缩写词后的空格
