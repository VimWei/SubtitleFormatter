...
class BasicPage(QWidget):
    def __init__(self, parent: QWidget | None = None):
        ...
        layout.addRow("Output:", row_output)
        ...
        row1_layout.addStretch()  # Push checkbox to the left
    ...
    def load_config_from_coordinator(self):
        ...
        self.set_config(input_file, output_file, add_timestamp)
