"""Version information for SubtitleFormatter.

This module provides version information for the SubtitleFormatter application.
...
def get_version_info() -> Tuple[int, ...]:
    ...
    Returns:
        Tuple[int, ...]: Version tuple (e.g., (0, 1, 0))
    """
    version_str = get_version()
    try:
        # Remove any pre-release suffixes (e.g., "0.1.0a1" -> "0.1.0")
...
def get_version_display() -> str:
    ...
    Returns:
        str: Formatted version string (e.g., "v0.1.0")
    """
...
def get_app_title() -> str:
    ...
    return f"SubtitleFormatter {get_version_display()}"


def get_about_text() -> str:
    """Get about text with version information."""
    version_info = get_full_version_info()
    text = f"""SubtitleFormatter {version_info['display']}
