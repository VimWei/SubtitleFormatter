...
from ..base.plugin_base import TextProcessorPlugin, PluginError, PluginInitializationError
...
class PluginLifecycleManager:
    ...
    def load_plugin(self, name: str, config: Optional[Dict[str, Any]] = None) -> TextProcessorPlugin:
        """
    ...
    def load_plugins(self, plugin_configs: Dict[str, Dict[str, Any]]) -> Dict[str, TextProcessorPlugin]:
        """
    ...
    def reload_plugin(self, name: str, config: Optional[Dict[str, Any]] = None) -> TextProcessorPlugin:
        """
