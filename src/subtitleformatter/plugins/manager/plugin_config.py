...
class PluginConfigManager:
    ...
    def load_plugin_config(self, plugin_name: str, config_path: Optional[Path] = None) -> Dict[str, Any]:
        """
        ...
        if config_path.exists():
            ...
            logger.warning(f"Configuration file not found for plugin '{plugin_name}': {config_path}")
            return {}
    ...
    def validate_plugin_config(self, plugin_name: str, config: Dict[str, Any], schema: Optional[Dict[str, Any]] = None) -> List[str]:
        """
