...
class ScriptsManager:
    ...
    def _load_registry(self) -> Dict:
        ...
        return {
            ...
            "clean-vtt": {
                ...
                "examples": ["scripts_manager.py clean-vtt input.vtt"],
                "category": "converter",
            },
            "transcript-converter": {
                ...
                "examples": ["scripts_manager.py transcript-converter input.transcript"],
                "category": "converter",
            },
            "srt-resegment": {
                ...
                "examples": ["scripts_manager.py srt-resegment timestamps.json input.srt"],
                "category": "converter",
            },
            "release": {
    ...
    def show_help(self, script_name: str):
        ...
        try:
            subprocess.run(
                [sys.executable, str(script_path), "--help"], check=True, cwd=self.scripts_dir
            )
