...
for filepath in input_files:
    ...
    try:
        ...
        # Step 2: Apply the user's precise replacement rules as a final post-processing step.
        result = punctuated_text.replace(' - ', ', ')
        result = result.replace('- ', ', ')

        # Step 3: Write the final, corrected text to the output file.
        with open(output_filepath, 'w', encoding='utf-8') as f:
            f.write(result)
