...
class SequenceAligner:
    ...
    def _backtrack_alignment(
        self, matrix: List[List[int]], seq1: List[str], seq2: List[str]
    ...
    def _calculate_statistics(
        self, differences: List[WordDifference], old_len: int, new_len: int
    ) -> Dict[str, Any]:
        """
        计算统计信息
        ...
        similarity_ratio = (
            (total_words - total_differences) / total_words if total_words > 0 else 1.0
        )
